 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://server/", "HelloImplService");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://server/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "HelloImplPort"), Hello.class, features);
    }
